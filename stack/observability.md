...
- **Demote stale cost claims**: the companion proposes that a cost claim whose price-table audit is more than seven days old drops to inference; no surveyed repository was shown doing this. Starter kit: B8. [Inference] (ecosystem/pickup/pickup-observability.md:167 "whose price-table audit is older than 7 days is demoted to T3")
