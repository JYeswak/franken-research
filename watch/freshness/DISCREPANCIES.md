...
All facts below are from the reference fixture `watch/freshness/fixtures/core/` (recorded 2026-09-25 01:42 UTC, see `fixtures/PROVENANCE.md`) unless a packet line is cited.
