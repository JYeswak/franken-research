...
Last run: 2026-09-24 06:12 UTC. Watched: 8 repositories (7 pinned, 1 from cohort matrices). Data: [watch/live.json](https://github.com/JYeswak/franken-research/blob/main/watch/live.json).
...
14 triggers across 7 repositories need a person to check them. They are listed, never alerted: [watch/freshness/revisit.tsv](https://github.com/JYeswak/franken-research/blob/main/watch/freshness/revisit.tsv).

## Informational

- Events that moved no computed class: 23 today, 311 since the pins.
- Crossings seen once, not yet open: 1.
- Repository states: 3 current, 3 changed, 1 due, 1 unknown.
